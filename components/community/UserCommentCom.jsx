    ...
    <View className="px-6 py-2">
      <View>
        ...
        <View className="pl-16">
          ...
          {/* reply button */}
          <TouchableOpacity onPress={openReply} className="py-1 px-2 bg-gray-100 rounded-3xl mt-2 w-12">
          ...
          {isReplyClicked && (
            <View className="flex flex-row items-center mt-2">
              ...
              <TouchableOpacity onPress={handleSendReply} className="p-2 rounded-full border border-cyan-50 h-8 w-8">
