                  ...
                  <View>
                    ...
                    <View className="mb-3">
                      ...
                      <Text className="text-xs">
                        ...
                        customization options, including exclusive themes,
                        custom invitations, and event branding.
                      </Text>
                    </View>
                    <View className="mb-3">
                      <Text className="text-sm font-bold">Recommendation</Text>
                      <Text className="text-xs">
                        Receive personalized event and venue recommendations
                        based on preferences, location, and past activity within
                        the app.
                      </Text>
                    </View>
                    <View className="mb-3">
                      ...
                      <Text className="text-xs">
                        Access a priority support hotline with 24/7 assistance
                        for immediate and personalized problem resolution.
                      </Text>
                    </View>
                  </View>
                ...
                <View>
                  ...
                  <View>
                    ...
                    <View className="mb-3">
                      ...
                      <Text className="text-xs">
                        Experience the ability to not only view but also
                        download images and videos whenever you want as a
                        Baller.
                      </Text>
                    </View>
                    <View className="mb-3">
                      ...
                      <Text className="text-xs">
                        Access tools for enhanced profile customization,
                        allowing Ballers to showcase their status with unique
                        badges, premium backgrounds, and exclusive profile
                        elements.
                      </Text>
                    </View>
                    <View className="mb-3">
