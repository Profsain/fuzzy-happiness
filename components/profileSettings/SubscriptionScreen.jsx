	...
	return (
		<>
			<SafeAreaView style={styles.container}>
				...
				<View style={styles.tabContainer} className="px-6">
					<TouchableOpacity
						style={[
							styles.tab,
							activeTab === "Platinum" && styles.activeTab,
						]}
					...
					<TouchableOpacity
						style={[
							styles.tab,
							activeTab === "Ballers" && styles.activeTab,
						]}
					...
					{activeTab === "Platinum" ? (
						<ScrollView>
							...
							<View>
								...
								<View>
									<View className="mb-3">
										...
										<Text className="text-xs">
											Platinum members can split bills
											seamlessly with an extended grace
											period, allowing for more
											flexibility in managing shared
											expenses.
										</Text>
									</View>
									<View className="mb-3">
										...
										<Text className="text-xs">
											Platinum members can create events
											with advanced customization options,
											including exclusive themes, custom
									...
									<View className="mb-3">
										...
										<Text className="text-xs">
											Receive personalized event and venue
											recommendations based on
											preferences, location, and past
									...
									<View className="mb-3">
										...
										<Text className="text-xs">
											Access a priority support hotline
											with 24/7 assistance for immediate
											and personalized problem resolution.
										</Text>
									</View>
								</View>
								...
								{/* subscribe button */}
								<View className="mt-8 mb-16 items-center">
									...
									<Text className="mt-8">
										This is a 12 month plan. By proceeding
							...
							<View>
								...
								<View>
									<View className="mb-3">
										...
										<Text className="text-xs">
											Join and create elite,
											invitation-only communities,
											ensuring a highly curated and
											exclusive social circle within the
											app.
										</Text>
									</View>
									<View className="mb-3">
										...
										<Text className="text-xs">
											Experience the ability to not only
											view but also download images and
											videos whenever you want as a
											Baller.
										</Text>
									</View>
									<View className="mb-3">
										...
										<Text className="text-xs">
											Access tools for enhanced profile
											customization, allowing Ballers to
											showcase their status with unique
											badges, premium backgrounds, and
											exclusive profile elements.
										</Text>
									</View>
									<View className="mb-3">
										<Text className="text-sm font-bold">
										...
										<Text className="text-xs">
											...
											and product testing, allowing
											Ballers to influence the direction
											of the app.
										</Text>
									</View>
								</View>
