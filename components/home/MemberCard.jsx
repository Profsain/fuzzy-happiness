...
const MemberCard = ({ user, showActions = false, onAccept, onDecline, onView }) => {
    return (
      <View className="items-center mx-2 p-3 border border-gray-300 rounded-xl w-36 bg-gray-50">
        <Image
        ...
        <View className="flex flex-row mt-1 space-x-2">
          ...
          {showActions && (
            <>
              <TouchableOpacity onPress={() => onDecline(user)} className="mx-4">
